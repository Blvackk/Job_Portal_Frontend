...
export const fetchEmployerApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-portal-backend-44uu.onrender.com/api/v1/application/employer/getall`,
      {
...
export const fetchJobSeekerApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-portal-backend-44uu.onrender.com/api/v1/application/jobseeker/getall`,
      {
        withCredentials: true,
      }
    );
...
export const postApplication = (data, jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `https://job-portal-backend-44uu.onrender.com/api/v1/application/post/${jobId}`,
      data,
      {
        withCredentials: true,
...
export const deleteApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://job-portal-backend-44uu.onrender.com/api/v1/application/delete/${id}`,
      { withCredentials: true }
    );
    dispatch(
